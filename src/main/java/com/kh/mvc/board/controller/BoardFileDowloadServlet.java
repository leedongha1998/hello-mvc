...
/**
 * Servlet implementation class BoardFileDowloadServlet
 */
@WebServlet("/board/fileDownload")
public class BoardFileDowloadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			// 출력 - http응답메세지 출력스트림 response.getOutputStream()
